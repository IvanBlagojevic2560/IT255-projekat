    ...
    return {
        ...
        execute: function() {
            NarudzbineComponent = (function () {
                function NarudzbineComponent(builder, http, router) {
                    var _this = this;
                    this.http = http;
                    this.router = router;
                ...
                NarudzbineComponent.prototype.remove = function (item) {
                    ...
                    this.http.get('http://localhost/phpprojekat/obrisiNarudzbinu.php?id=' + item, { headers: headers }).subscribe(function (data) { return _this.postResponse = data; });
                    location.reload();
                };
