System.register(['angular2/core', 'angular2/common', 'angular2/http', 'rxjs/Rx', 'angular2/router'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ProizvodiComponent = (function () {
                function ProizvodiComponent(builder, http, router) {
                    var _this = this;
                    this.http = http;
                    this.router = router;
                ...
                ProizvodiComponent.prototype.removeServis = function (item) {
                    var _this = this;
                    console.log("Remove: ", item);
                    var headers = new http_1.Headers();
                    headers.append('Content-Type', 'application/x-www-form-urlencoded');
                    headers.append('token', localStorage.getItem('token'));
                    this.http.get('http://localhost/phpProjekat/deleteservis.php?id=' + item, { headers: headers }).subscribe(function (data) { return _this.postResponse = data; });
                    location.reload();
                };
                ProizvodiComponent.prototype.editItem = function (item) {
            ...
            exports_1("ProizvodiComponent", ProizvodiComponent);
        }
    }
});
